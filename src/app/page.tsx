  ...
  return (
    <>
      ...
      <section id="services" className="section-wrapper">
        ...
        <div className="services-grid stagger" style={{ marginTop: "2rem" }}>
          ...
          <div className="service-card fade-in">
            ...
            <p className="service-body">
              Custom AI systems, built to spec. Orchestration layers that connect
              your existing tools. Agents that handle real work. Infrastructure
              that scales. I don&apos;t hand you a demo and disappear. I build
              production systems and fit them into your operations.
            </p>
          </div>
      ...
      <footer className="footer">
        <div className="footer-top">
          <span className="footer-copy">© 2026 Grant Mahn</span>
        ...
        <p className="footer-colophon">
          Set in Space Grotesk and Inter. Built with Next.js. Measured, cut, and
          stitched by hand.
          <span className="footer-signature"> — GM</span>
        </p>
      </footer>
    </>
  );
